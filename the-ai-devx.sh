...
# ------------------------------------------------------------------
#  INSTALLER: Mr.the-ai-dev (MAXIMUM VIBES Edition) 🎩🔥
...
echo "🔥 Re-summoning Mr.the-ai-dev (MAXIMUM VIBES)..."

# Create the post-commit hook with MAXIMUM functionality
cat > "$HOOK_FILE" << 'EOF'
#!/bin/bash
...
chmod +x "$HOOK_FILE"
echo "🚀 Mr.the-ai-dev is back with MAXIMUM VIBES & PERSONALIZATION!"